...
Created time: 22 April 2025 17:05
ID: POL-94
...
Last edited time: 7 October 2025 15:54
Parent item: Ethical Policy (Ethical%20Policy%201c0d6625c6798145af23ca6e8f86029c.md)
Status: Not started
Version Number: 1.1
weight: 10
---
...
This policy applies to all employees, contractors, and stakeholders involved in hiring, onboarding, and other areas where ethical screening is required. It is designed to comply with ISO 30401 standards for Knowledge Management Systems (KMS) and align with the organization's strategic direction for information security and ethical management.

## Objectives

- Ensure ethical compliance in all organizational processes.
- Enhance the effectiveness of screening for new hires, contractors, and partners.
- Improve onboarding procedures to uphold the organization’s values and ethical principles.
- Align with the ISO 30401 standard and relevant ISO Groups, particularly A.5.1, which focuses on policies for information security.

## Policy Statement

The organization is committed to embedding ethical considerations into its processes and decisions. Screening and onboarding activities will be conducted in a manner that reflects our core values and supports our strategic goals. This includes verifying the ethical background of potential employees and partners to ensure alignment with the organization’s standards.

## Procedures

1. **Screening Processes**:

    Ethical screening will include background checks, reference verification, and alignment with the organization’s values. These checks will be conducted in compliance with local laws and regulations.

2. **Onboarding Improvements**:

    Onboarding processes will integrate ethical training and clear communication of the organization’s ethical expectations. New employees will be guided on the standards and practices outlined in this policy.

3. **Compliance and Verification**:

    All screening and onboarding processes will be documented and verified to ensure alignment with the ISO 30401 standards and other relevant ISO Groups, such as A.5.1.

4. **Monitoring and Reporting**:

    Regular monitoring and reporting mechanisms will be established to evaluate the effectiveness of the screening and onboarding processes. Any identified gaps or issues will be addressed promptly.

## Roles and Responsibilities

- **Owner**: Ryan Laird

    Responsible for overseeing the implementation and maintenance of this policy.

- **Management Functions**: Ethics

    Responsible for ensuring that all ethical considerations are integrated into screening and onboarding processes.

- **Verification Team**:

    Ensures that all processes comply with ISO 30401 standards and are regularly reviewed for improvement.

## Governance

This policy falls under the hierarchy of Level 1 – Strategic Direction and is classified as Policy (Doc. classification ID: 1472). It is aligned with the organization’s Knowledge Management System (KMS) and information security policies under ISO Group A.5.1.
...
This policy will be reviewed periodically, with updates made as necessary to reflect changes in organizational strategy, regulatory requirements, or ethical standards.

## References

- ISO 30401: Knowledge Management System (KMS)
- ISO Group A.5.1 - Policies for Information Security
- Tasks: Enhance screening processes, improve onboarding
- Management Code: ETH
- Archive Status: No
