...
Last edited time: 7 October 2025 18:53
Parent item: Breach & Incident Management Policy (Breach%20&%20Incident%20Management%20Policy%201e2d6625c6798005ab08d604450e3d7b.md)
Status: Not started
Version Number: 1.1
weight: 10
---
...
This document outlines the policies and procedures for managing data breaches within the organization. It aligns with the ISO/IEC 27001 standards for Information Security Management Systems to ensure the confidentiality, integrity, and availability of sensitive information. The policy is classified as hierarchical Level 1, contributing to the organization’s strategic direction for information security.

## Purpose

The purpose of this document is to establish a clear framework for identifying, reporting, and mitigating data breaches. It aims to minimize the impact of breaches on the organization and its stakeholders while ensuring compliance with relevant legal and regulatory requirements.

## Scope

This policy applies to all employees, contractors, and third parties who handle or process organizational data. It covers all forms of data, including digital and physical records, and extends to all systems and platforms used within the organization.

## Roles and Responsibilities

### Owner

- **Ryan Laird**: As the owner of this policy, Ryan Laird is responsible for overseeing its implementation, ensuring it is regularly reviewed, and updating it to reflect changes in regulatory requirements or organizational needs.

### Security Management

- The **Security Management Function** is responsible for ensuring this policy aligns with the organization's overall security strategy and objectives.
- The management code for this policy is **SEC**.

### Employees and Contractors

- All personnel are required to adhere to the guidelines outlined in this policy and promptly report any suspected or confirmed breaches.

### Verification

- This policy has been verified and is in its **1.1 version**. It remains under review to ensure continued relevance and effectiveness.

## Policy Statement

The organization is committed to protecting sensitive information against unauthorized access, disclosure, alteration, and destruction. To achieve this, the following measures will be implemented:

1. **Incident Identification and Reporting**:
    - All data breaches, whether suspected or confirmed, must be reported immediately to the designated security team.
    - Reports must include details such as the nature of the breach, affected systems, and the potential impact.
2. **Incident Response**:
    - The security team will initiate an investigation to confirm the breach and assess its scope.
    - Affected systems will be isolated to prevent further damage or data loss.
3. **Mitigation and Recovery**:
    - Appropriate measures will be taken to mitigate the impact of the breach, including notifying affected stakeholders and restoring compromised systems.
    - Lessons learned will be documented to prevent future breaches.
4. **Compliance with Standards and Regulations**:
    - The organization will adhere to the ISO/IEC 27001 standard and any applicable legal or regulatory requirements for data breach management.
5. **Periodic Review**:
    - This policy will be reviewed annually or following a significant data breach to ensure it remains effective and up to date.

## Related Documents

- [Data Handling Guide](https://www.notion.so/Data-Handling-Guide-1c0d6625c679818c8b6ac62804bc5482?pvs=21): Provides detailed procedures for managing and protecting data.

## Classification and Publishing Information

- **IMS Reference**: ISMS/A5.1/POL/926
...
This document sets the foundation for managing data breaches effectively, ensuring alignment with ISO/IEC 27001 standards. It emphasizes the importance of proactive identification, response, and mitigation of breaches to safeguard organizational data and maintain stakeholder trust.

## Status and Updates

- **Status**: In Review
- **Last Edited By**: Ryan Laird
- **Last Edited Time**: May 1, 2025, 11:45 PM
- **Version Number**: 1.1

# **DATA BREACH POLICY**

| **Doc. ID** | POL/SEC/2024/1358-V1.1 | **Date of Last Revision** | 5 December 2024 |
| --- | --- | --- | --- |
...
In the event of a security incident or breach, staff must immediately inform the Data Protection Officer (DPO) at [dpo@greenorbit.space](mailto:dpo@greenorbit.space). The DPO will take the lead on investigating the breach.
