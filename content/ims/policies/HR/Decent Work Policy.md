...
At [Your Business Name], we are committed to providing decent work conditions for all our employees. This policy outlines our dedication to ensuring a work environment that is fair, safe, and respectful, promoting the dignity, well-being, and development of every employee.

**Scope**

This policy applies to all employees, contractors, and partners of [Your Business Name].

**Our Commitment**

1. **Fair Employment Practices:** We ensure fair and ethical employment practices by:

- Offering fair and competitive compensation and benefits.
- Upholding principles of equality and non-discrimination in hiring, promotions, and all employment practices.
- Ensuring job security and stability wherever feasible.

2. **Safe and Healthy Work Environment:** We are dedicated to providing a safe and healthy workplace by:
...
3. **Work-Life Balance:** We support the work-life balance of our employees through:

- Offering flexible working arrangements where possible.
- Encouraging reasonable working hours and adequate rest periods.
- Providing support for family responsibilities.

4. **Respect and Dignity at Work:** We are committed to maintaining a work environment where every individual is treated with respect and dignity. This includes:

- Zero tolerance for harassment, bullying, or any form of abuse.
- Promoting a culture of respect and consideration.
- Providing mechanisms for employees to report grievances and ensuring they are addressed promptly and fairly.

5. **Employee Development and Training:** We support the professional growth and development of our employees by:

- Providing access to training and development opportunities.
- Encouraging continuous learning and skill development.
- Offering career advancement opportunities.

6. **Social Dialogue and Employee Representation:** We believe in the importance of social dialogue and will:

- Encourage open and transparent communication between management and employees.
- Respect the rights of employees to organize and collectively bargain.
- Engage in constructive dialogue with employee representatives.

**Responsibilities**

- Management is responsible for implementing this policy and ensuring adherence.
- Employees are encouraged to uphold the principles of decent work and report any concerns.
- The Human Resources Department will oversee the application of this policy and address related concerns.

**Compliance and Review**

- We will comply with all relevant labour laws and regulations.
- This policy will be reviewed regularly to ensure its effectiveness and alignment with best practices and legal standards.

**Approval**

This policy is endorsed by the highest level of management at [Your Business Name], affirming our commitment to providing decent work for all our employees.

**Contact Information**

For more information or to report concerns related to this policy, please contact [Contact Person/Department].
...
We recognise that matters relating to harassment, discrimination and bullying can be complex and we want to ensure that our employees can access the appropriate training to ensure that they are clear on our expectations relating to their conduct. In addition, that they have the skills to identify any situations that do not support Green Orbit's values and the best method in which to escalate such. Training on this policy is therefore available to all employees and may be requested via your Line Manager.

# Dignity and Respect at Work Policy

# Overview

The Dignity and Respect at Work Policy outlines the organization’s commitment to fostering a workplace environment where all employees are treated with fairness, dignity, and respect. This policy is aligned with our strategic direction and supports our organizational values of equality, inclusivity, and professionalism.

This document is classified as a Level 1 Policy under the company’s hierarchy of strategic direction and adheres to ISO 26000 standards for Social Responsibility Management Systems. The policy is managed by the Human Resources (HR) department under the guidance of Ryan Laird, the document owner.

# Purpose

The purpose of this policy is to ensure that all employees:

- Are provided with a fair and respectful working environment.
- Understand their rights and responsibilities regarding workplace dignity and respect.
- Know the measures in place to address any incidents of disrespect, discrimination, harassment, or bullying.

# Scope

This policy applies to all employees, contractors, and stakeholders within the organization. It is designed to cover all work-related activities, whether conducted on or off company premises.

# Policy Statement

We are committed to:

1. **Promoting Fairness:** Ensuring that all employees are treated equitably and respectfully, regardless of their role, gender, age, ethnicity, or any other characteristic protected by applicable laws.
2. **Zero Tolerance for Harassment:** Creating a zero-tolerance policy for any form of bullying, harassment, or discrimination.
3. **Encouraging Open Communication:** Supporting employees in reporting concerns or grievances without fear of retaliation.
4. **Compliance with Standards:** Aligning with ISO 26000 standards for social responsibility and other relevant ISO standards, including A5.1 - Policies for Information Security.
5. **Continuous Improvement:** Regularly reviewing and updating the policy to ensure its effectiveness and alignment with the company’s objectives and legal requirements.
...
- Report any incidents of disrespect or harassment to the appropriate HR personnel.

Management:

- Lead by example in promoting a respectful workplace.
- Respond promptly and effectively to any reported concerns or violations of this policy.
- Ensure that all team members are aware of and understand this policy.

Human Resources (HR):

- Oversee the implementation and enforcement of the policy.
- Provide training and resources to ensure compliance.
- Investigate reported incidents and take appropriate action.

# Reporting and Resolution

Employees are encouraged to report any concerns regarding dignity and respect at work to their direct supervisor or the HR department. Reports will be treated confidentially, and investigations will be conducted promptly and impartially.

# Related Documents and References

- [Fair Working Policy - Earthwave](https://www.notion.so/Fair-Working-Policy-Earthwave-188d6625c6798119b576cfebe00bdafa?pvs=21)
- [Statement on Work Hours](https://www.notion.so/Statement-on-work-hours-d028e4cf652e4da58a4b8f5d37c7bae8?pvs=21)
- [ISO 26000: Social Responsibility Management System](https://www.notion.so/Social-Responsibility-Management-System-1bcd6625c679802ebb29cba68047cbf5?pvs=21)
- [A5.1 - Policies for Information Security](https://www.notion.so/A-5-1-Policies-for-Information-Security-1dfd6625c67980e6887fdda31fa16b03?pvs=21)
...
This policy is part of the organization’s Fair Working Policy framework and is aligned with our statement on work hours and broader commitments to social responsibility. It is maintained under the IMS reference code SRMS/A5.1/POL/945 and is classified as a low-priority document at this stage.

# Conclusion

This policy emphasizes the organization’s dedication to creating a workplace culture built on dignity, respect, and collaboration. We believe that this approach contributes to employee satisfaction, productivity, and the overall success of the organization.

For additional information or queries, please contact the Human Resources department.

**Last Edited By:** Ryan Laird

**Last Edited Time:** May 1, 2025, 11:25 PM
