...
2. **Use of HMRC’s CEST Tool**: Employment status is assessed using the **Check Employment Status for Tax (CEST)** tool and internal review criteria.
3. **Issuance of SDS**: HR issues a written Status Determination Statement including the reasoning behind the decision.
4. **Communication and Record-Keeping**: SDS is shared with the worker and/or intermediary. All records are retained in compliance with data protection requirements.
