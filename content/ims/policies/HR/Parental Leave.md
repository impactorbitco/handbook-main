...
Last edited time: 8 October 2025 04:29
...
| **Doc. ID** | POL/HR/2025/875-V1.1 | **Date of Last Revision** | 5 December 2024 |
| --- | --- | --- | --- |
...
2. To be eligible for maternity leave you must:
...
3. The right to take maternity leave is not dependent on your length of service, although to qualify for statutory maternity pay, you must have at least 26 weeks of service at the Qualifying Week.
4. You may be eligible to take shared parental leave instead of your full entitlement of maternity leave. For details about shared parental leave, see the Employer’s Shared Parental Leave Policy available from your line manager or the HR Department.
...
2. You must tell us before the end of the Qualifying Week, or as soon as reasonably practical afterwards, that you are pregnant, the dates of your Expected Week of Childbirth and when you would like your maternity leave to start.
3. You must also confirm your Expected Week of Childbirth by providing us with a certificate from a doctor or midwife (this will usually be on a MAT B1 form).
...
2. Pregnancy-related sickness absence will not be taken into account for the purpose of any employment decisions to which sickness absence is relevant.
3. During the 4 weeks immediately before your Expected Week of Childbirth, any sickness absence will normally automatically trigger the start of your maternity leave.
...
2. Your maternity leave cannot start earlier than 11 weeks before the Expected Week of Childbirth (unless you give birth prematurely before then). Within 28 days of receiving your notice, we will confirm to you in writing the last date by which you must return from maternity leave.
3. You can change the start date for your maternity leave by giving us written notice. You must give the notice at least 28 days before the earlier of (i) the new start date or (ii) the original start date. If it is not possible to give that much notice then you must notify us as soon as reasonably practicable.
4. Your maternity leave will start on the date notified to us in accordance with this policy unless:
...
5. SMP will stop being payable if you return to work (except where you are simply keeping in touch as described in the "During maternity leave" section below).
6. If you leave employment after the start of the Qualifying Week you will still be eligible for SMP from the later of (i) the week following your final week of employment or (ii) the 11th week before the Expected Week of Childbirth.
...
2. A day for the purpose of KIT Days does not necessarily mean a full or standard work shift of normal duration but can be any length of time (e.g. a half-day or a partial day).
3. You will be paid at your normal basic rate of pay for time spent working on a KIT Day and this will be inclusive of any maternity pay entitlement.
4. We affirm that we will not force any employee to use any KIT Days. An employee may freely and without penalty turn down any request we may make for them to attend the workplace for a KIT Day. Similarly, we may also freely reject any request that an employee makes to use a KIT Day.
5. If you would like to discuss this option further, you should speak with your line manager or the HR Department.
...
2. If you plan to come back to work on the return date that we have notified to you then you are not obliged to do anything further, although we would be grateful if you would help us plan ahead by confirming during your leave that you will return as expected.
3. If you wish to return to work earlier than the date that we have notified to you then you will need to give us at least 8 weeks' prior notice of the new date and we request that you do this in writing. If you don't give us 8 weeks' notice then we may postpone your return until the sooner of 8 weeks from the date of your notice or the date that you were originally expected to return.
4. If you wish to return later than the date we have notified to you then you should either:
...
5. If sickness absence prevents you from returning on the planned date then the normal rules relating to sickness absence will apply.
6. In any other case, late return will be treated as unauthorised absence.
7. If you decide not to return to work at all then you must give notice of resignation in accordance with your contract of employment. If your maternity leave is due to end during the currency of your notice period then you may be required to return to work until your notice period expires.
...
# Pregnancy and Maternity Leave and Pay Policy

## Purpose

This policy outlines the provisions and guidelines for pregnancy and maternity leave and pay, ensuring compliance with relevant occupational health and safety standards, as well as promoting the well-being of employees during maternity. This document is part of our organization's commitment to supporting employees and meeting the Sustainable Development Goal (SDG 01) of reducing poverty by providing adequate leave and pay benefits.

## Scope

This policy applies to all full-time employees eligible for maternity leave and pay under state and federal regulations. This document is classified as a Level 1 – Strategic Direction policy and aligns with ISO 45001 standards for Occupational Health and Safety Management.

## Policy Overview

The organization is committed to providing support to employees during pregnancy and maternity by offering leave and pay provisions that comply with legal requirements and promote a safe and supportive workplace environment.

### Key Provisions

1. **Eligibility**

    Employees must meet the following criteria to qualify for maternity leave and pay:

    - Be employed on a full-time basis.
    - Meet the minimum tenure requirement as per state and federal laws.
    - Submit the required documentation, including a medical certificate confirming pregnancy, within the stipulated timeline.
2. **Leave Entitlement**

    Eligible employees are entitled to a minimum of 15 days of paid maternity leave, as outlined in the SBA ESG Self-Assessment guidelines. Additional unpaid leave may be provided as required by state leave provisions.

3. **Maternity Pay**

    Employees on maternity leave will receive their standard salary during the paid leave period. Any extensions beyond the paid leave period will adhere to state and federal guidelines.

4. **Health and Safety**

    The organization will ensure that pregnant employees have access to a safe work environment. Adjustments to work responsibilities may be provided to accommodate health or safety concerns.

5. **State Leave Provisions**

    This policy incorporates applicable state leave provisions as outlined in the relevant guidelines. Employees are encouraged to review the "State Leave Provisions" document for detailed information.

6. **Return to Work**

    Employees returning from maternity leave will be reinstated to their original position or an equivalent position with the same terms and conditions of employment.

## Responsibilities

- **Human Resources Department**: Responsible for managing maternity leave requests, ensuring compliance with this policy, and providing guidance to employees.
- **Management**: Responsible for supporting employees and ensuring the implementation of this policy within their teams.
...
This policy aligns with the organization's strategic goals and is verified under ISO 45001 standards. For further information or clarification, employees may contact the Human Resources Department.

## Related Documents and References

- [State Leave Provisions](https://www.notion.so/State-Leave-Provisions-137d6625c67981d7a4b4d30a5f3d954e?pvs=21)
- [SBA ESG Self Assessment](https://www.notion.so/Does-your-company-offer-at-least-15-days-annual-paid-leave-for-full-time-employees-1d8d6625c679800d8e51cd49a9204627?pvs=21)
- [ISO 45001: Occupational Health and Safety Management](https://www.notion.so/Occupational-Health-and-Safety-Management-1b5d6625c679806a9549eedb564e326a?pvs=21)

This document is classified as Policy (IMS Ref.: OHSM/A5.1/POL/884). It is part of the A.5.1 ISO group for Policies for Information Security and supports the organization's wider strategic and human resources functions.
...
**Note:** GitLab offers up to 16 weeks of paid [general parental leave benefit](https://handbook.gitlab.com/handbook/total-rewards/benefits/general-and-entity-benefits/#parental-leave) where, if eligible, statutory pay is supplemented up to 100% regular salary.
...
**Neonatal Care Pay (NCP)** is available to eligible employed parents who will be able to claim up to 12 weeks of NCP. To be eligible, team members must:
