...
[ISO 30401 - Common ISO Clauses](https://www.notion.so/1ded6625c6798049b525f6ec2513a871?pvs=21)
...
> 
> 
> *This policy supports the organisation’s strategic goals by embedding knowledge-sharing behaviours, standardising practices, and fostering a collaborative and transparent culture. Knowledge management is essential to maintaining quality, agility, and purpose in how we serve our clients, engage stakeholders, and scale our impact.*
> 
...
- **Provide Learning Opportunities**:
    - Internal knowledge-sharing sessions (e.g., retrospectives, lunch & learns)
    - Micro-trainings and onboarding guides for new staff
    - External professional development where needed (e.g., ISO, sustainability reporting, digital tooling)
...
- **Knowledge Flow and Usage**
    - Volume of knowledge assets created, accessed, and reused
    - Frequency and diversity of internal contributions to the knowledge base
    - Use of templates, toolkits, and shared resources in client delivery
- **Stakeholder Value**
    - Internal staff feedback on usefulness, accessibility, and relevance of knowledge
    - External stakeholder satisfaction with shared insights, reports, or collaborations
    - Outcomes from knowledge-enabled initiatives, e.g. improved client retention or campaign impact
- **Learning and Innovation**
    - Number of lessons learned and applied across projects
    - Insights contributing to service innovation, sustainability outcomes, or market positioning
- **Operational Efficiency**
    - Time saved through knowledge reuse
    - Reduction in duplicated efforts and gaps in knowledge handover
- **Sustainability and Compliance**
    - Knowledge alignment with sustainability goals (e.g. ISO 14001, B Corp impact)
    - Evidence of KMS contributing to ethical sourcing, environmental standards, or space sector integrity
...
- **Methodology**:
    - Review of documentation, systems, and workflows
    - Interviews or surveys with staff and key stakeholders
    - Assessment of knowledge sharing culture, access, and barriers
...
1. **Identification**
    - Nonconformities may arise during audits, team retrospectives, stakeholder feedback, or routine monitoring.
    - Examples include inaccessible knowledge assets, inconsistencies in documentation, or a breakdown in knowledge sharing across projects.
2. **Documentation**
    - All nonconformities are logged in a central issue tracker (e.g. Notion database or compliance register), including description, origin, impact, and responsible parties.
3. **Root Cause Analysis**
    - Using tools such as the “5 Whys” or fishbone diagrams, root causes are analysed collaboratively to identify systemic issues, knowledge bottlenecks, or behavioural barriers.
4. **Corrective Action**
    - Corrective measures are defined and implemented with clear accountability and timelines.
    - Actions may include training, process redesign, access controls, or enhanced communication channels.
5. **Verification**
    - Effectiveness of the corrective action is evaluated through follow-up reviews and testing.
6. **Learning Capture**
    - Insights are documented as lessons learned and integrated into the KMS to support future prevention and organisational learning.
...
- **Staff Input and Ideation**
    - Regular opportunities (e.g. retrospectives, workshops, surveys) are provided for staff to suggest improvements, innovations, or share frustrations related to knowledge practices.
- **Lessons Learned Reviews**
    - Each major project or campaign includes a formal lessons learned session, with results documented, reviewed, and shared across teams.
- **Benchmarking and Learning from Others**
    - Green Orbit Digital stays informed of industry best practices and emerging trends in knowledge management, sustainability, and digital innovation through networks, memberships, and sector partnerships.
- **Technology and Tools Review**
    - Periodic assessments of platforms (e.g. Notion, HubSpot, Miro, etc.) ensure that tools are fit for purpose and upgraded as needed to support efficient knowledge flows.
- **KMS Innovation Initiatives**
    - The organisation may periodically pilot new knowledge-sharing methods (e.g. storytelling, interactive dashboards, microlearning, AI-assisted documentation) to test impact and adoption.
- **Sustainability Alignment**
    - Continuous improvement includes regular checks to ensure that knowledge practices support Green Orbit Digital’s commitments to ethical, environmental, and social responsibility—contributing to initiatives like B Corp certification and ISO compliance.
...
[Lessons Learned](https://www.notion.so/1c4d6625c67980939c5df78e13614588?pvs=21)