...
- Formulate Research Operations strategy to continuously improve Research Operations performance
...
>
> - Unsure on where to get started? Check out our [handbook page on recording a presentation in Zoom](/handbook/security/corporate/end-user-services/supported-apps/zoom/zoom-tips/#how-to-share-a-presentation-in-zoom). A free Zoom account is all you'd need to complete this presentation.
...
- Create an open and collaborative culture based on trust in the UX Research team.
- Manage the Research Operations Coordinator by supervising all activities necessary to ensure Research Operations provides efficient support for the UX Research team, and secure compliance
- **Set Research Operations vision that supports the UX Research vision**, and formulate Research Operations strategy to continuously improve ReOps performance.
...
- Align the way that UX Researchers work with how their cross-functional partners in Product Management, Product Design, and Engineering prioritize, track, and manage work.
