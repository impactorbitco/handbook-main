...
1. Establish plans for your team to realize commercial viability from the product (Aligning Teams with Values)
...
Beyond the [base requirements](#base-pm-requirements) and Senior Product Manager Requirements, Principal Product Manager requirements are:
...
- Experience with import/export/migration features and functionality
...
Do you have a passion for ensuring what gets shipped to users is valuable? Are you a Product Manager who has always wanted to build tools that enable other Product Managers and whole organization to make data driven decisions? GitLab's Analytics section will enable different stakeholders (from product, engineering to finance) to answer the key question of DevOps delivery - is what I built valuable to my users?
...
- Collaborate with Engineering and other teams to build a strong foundation (automated, reusable, extensible)
...
1. **Recruiter Screen** with one of our global recruiters. Expect to discuss your background, your experience in relation to the role, your core PM comptencies, compensation expectations and a time for your questions at the end. Typically 30-45 minutes.
1. **Hiring Manager Interview** - This interview will touch on a number of topics to determine product management, company and values fit for the PM team at GitLab. 45 minutes.
1. **Deep Dive Interview** - The goal of this interview is to understand your ability to communicate a long term vision as well as short term MVC, both verbally during the interview itself, and written via a couple of follow up issues. The PM interviewer will provide feedback and see how you respond to that feedback. This mimics the way we operate at GitLab. 45 minutes + a couple of follow ups.
1. **Engineering Manager and Product Design Interview** - You will meet with stable-counterparts in Engineering and UX where we will be assessing your collaboration, soft skills, and development group fit. 45 minutes.
1. **Leadership Interview** - The final interview will focus on two main areas, your product thinking as well as a case interview to determine your business skills. 60 minutes.
