...
- Evidences the ability to seamlessly align cross-functional stakeholders in important initiatives with tradeoffs and
...
- Extends that of the Staff, Principal, or Director level Strategy and Operations
- Is GitLab's key point of contact with [JiHu](https://about.gitlab.com/blog/2021/03/18/gitlab-licensed-technology-to-new-independent-chinese-company/), an independent company in China that is licensed to sell GitLab software
...
- Captures the voice of the CEO in key internal and external communications
...
We are exploring ways to measure performance.
