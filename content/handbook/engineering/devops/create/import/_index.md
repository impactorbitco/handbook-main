...
[features we support per category](/handbook/product/categories/features/#import-and-integrate).
...
- What we're doing and why. This should contain enough context for someone unfamiliar with the issue to pick it up.
- Links to relevant issues, blockers, UI designs, etc.
- A clear list of functional requirements/acceptance criteria for the change. This is useful for both implementation and
testing.
- Non-functional requirements:
  - License level this feature applies to
  - Whether a [feature flag](https://docs.gitlab.com/development/feature_flags/) is needed
  - [Instrumentation](https://docs.gitlab.com/development/internal_analytics/) requirements
  - Documentation changes
  - Performance requirements
  - Testing requirements
- The issue description has been updated to reflect any decisions made in the comments.

**Bug readiness**

Bugs do not need to be perfectly understood before we work on them. The effort to fully understand a bug is often
most of the effort of fixing it. Consequently, proposed solutions in bug issues may be considered **suggestions** made
on an imperfect understanding of the defect.

Try to include the at least:

- Steps to reproduce
- Current behavior
- Expected correct behavior

Optionally, consider using the
...
Two Backend Engineers take on the "Milestone Doctor" role at every milestone. Their capacity for Deliverable work is reduced to 60% to allow taking over additional responsibilities as "Milestone Doctors".

The current doctors can be tagged with `@gitlab-org/foundations/import-and-integrate/reaction-rotation`.
...
- Two Backend Engineers claim shifts themselves on the [Milestone Doctor schedule spreadsheet](https://docs.google.com/spreadsheets/d/1N6ObBcCnliu4uZS-_IbpsjzgrF5f-etcLohYKAzR6KQ/edit?usp=sharing).
- At the beginning of a new milestone, Milestone Doctors update [membership of `@gitlab-org/foundations/import-and-integrate/reaction-rotation`](https://gitlab.com/groups/gitlab-org/foundations/import-and-integrate/reaction-rotation/-/group_members?with_inherited_permissions=exclude).
