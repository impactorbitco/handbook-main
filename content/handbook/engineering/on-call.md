...
More details can be found in the [Tier 1 section of the on-call handbook pages](./infrastructure/incident-management/on-call/tier-1.md).
...
More details can be found in the [Tier 2 section of the on-call handbook pages](./infrastructure/incident-management/on-call/tier-2.md)
...
We use [incident.io](https://app.incident.io/) to set the on-call
