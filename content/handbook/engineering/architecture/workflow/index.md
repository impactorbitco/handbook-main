...
1. For security-sensitive components, include a preliminary [threat model](/handbook/security/product-security/application-security/threat-modeling/) in your design document. This should identify key security boundaries, potential attack vectors, security assumptions, and mitigation strategies. Consult existing [threat models examples](https://gitlab.com/gitlab-com/gl-security/product-security/appsec/threat-models/-/tree/master) for guidance.
...
1. [Application Security](/handbook/security/product-security/application-security/#contacting-us) can provide guidance and review for threat models when security-sensitive components are involved.
