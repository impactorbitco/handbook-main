...
1. Being invited by an Organization Owner. Because Organizations are private for
   now, only the Organization Owner can add new Users to an Organization
...
For Protocells, an Organization can only be private. Private Organizations can
