...
**Release and Deploy (formerly Delivery)**

| **Channel** | **Purpose** |
|-----------|-----------|
|[#g_release_and_deploy](https://gitlab.enterprise.slack.com/archives/CCFV016SV)| Delivery Group channel|
...
- Thursday: Group Level Reviews conducted and added as threads in [Infrastructure Platforms Top Level epic](https://gitlab.com/groups/gitlab-com/-/epics/2115) (see [example](https://gitlab.com/groups/gitlab-com/-/epics/2115#note_2197983622))
  ...
  - Developer Experience: run by the Developer Experience EM+ and a rotation of Product Managers
...
Demos are one of our best tools for knowledge sharing. We encourage every team, and sometimes every project to schedule a regular demo call to talk through what they're working on, allowing others to learn about the topic, while also bringing in informal feedback and new ideas. Demos provide a forum for all team members to share their experience, knowledge, and different perspectives with each other.

Demo calls tend to be most successful when people talk about what they were working on without aiming for a polished presentation. It doesn't need to be perfect or polished and in many cases it was very much a work-in-progress where pieces don't yet work. Talking through the problem that you're trying to solve, the way you're solving it, and soliciting feedback and conversation on approaches helps us share knowledge and build better solutions.

Demo calls are most valuable when they feel like casual conversations rather than formal presentations. The goal isn't to showcase perfect, polished work.
If nobody has added anything to the agenda when the demo call starts, team members are encouraged to do an impromptu demo of whatever they're working on, have on their mind, etc.

When scheduling a new demo call we encourge people to add it to the Infrastructure Platforms calendar (gitlab.com_oji6dki1frc8g8qq9feuu1jtd0@group.calendar.google.com)
) for visibility.

> [!note]
> Additionally team members are encouraged to share demos in the [#demo-club](https://gitlab.enterprise.slack.com/archives/C099AB7H3M4) slack channel to enable knowledge sharing beyond infrastructure.
...
| [Dedicated Group](/handbook/engineering/infrastructure-platforms/gitlab-dedicated/) | [Mission](/handbook/engineering/infrastructure-platforms/gitlab-dedicated/#mission) |
