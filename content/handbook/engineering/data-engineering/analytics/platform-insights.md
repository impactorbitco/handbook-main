...
The Platform Insights group is part of the GitLab [Analytics Stage](/handbook/engineering/data-engineering/analytics/) and builds [GitLab Observability](https://about.gitlab.com/direction/monitor/platform-insights/) and [Product Analytics](https://about.gitlab.com/direction/monitor/platform-insights/) products.

### Team members

{{< team-by-manager-role "Engineering Manager(.*)Analytics:Platform Insights" >}}
