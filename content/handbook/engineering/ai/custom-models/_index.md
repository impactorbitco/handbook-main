...
Team members should add any [Paid Time Off](/handbook/people-group/time-off-and-absence/time-off-types/) in the "Workday" slack app, so that the Engineering Manager can use the proper number of days off during capacity planning. Where possible, try to add time off a full milestone in advance.
