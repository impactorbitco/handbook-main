...
1. **Use [Fast Quarantine](test-governance/detailed-quarantine-process.md#fast-quarantine)** for an urgent quarantine
2. **Follow up with a [long-term quarantine](test-governance/detailed-quarantine-process.md#long-term-quarantine)**
3. Tag this issue with `~quarantine` and `~automation:prevent-auto-close`

[Quarantine Process - Quick Reference](quarantine-process.md)
