...
- Create an [Access Request](https://gitlab.com/gitlab-com/team-member-epics/access-requests/-/issues/new?issuable_template=Individual_Bulk_Access_Request) specifying
  ...
  - level of access required (Readonly, Support, Provisioner, Operator, Migration Operator)
    - Environment Automation team members should apply for the Operator role
    - Migration team members should apply for the Migration Operator role
...
- Further documentation describing these roles and permissions can be found [here](https://about.gitlab.com/direction/platforms/switchboard/internal-user-roles)
