...
- [Get attention from Gitaly team](/handbook/engineering/infrastructure-platforms/tenant-scale/gitaly/#how-to-contact-the-team): issues related to Git and Git repositories, Gitaly Cluster, including data recovery.
...
1. Keep the [IMOC Rotation emails spreadsheet](#imoc-rotation-emails-spreadsheet) up to date and export them monthly from incident.io.
...
Search for Pagerslack in Tableau
