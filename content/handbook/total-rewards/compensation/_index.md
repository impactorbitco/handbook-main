...
* **New framework launch:** Market-aligned compensation ranges will be implemented by ~~August 30, 2025~~ (Revised Date Pending)
...
* **Your current range:** Available in your Workday profile under the compensation tab if your range was previously available in the Compensation Calculator
  * Commission-eligible Sales roles not previously in the calculator will be visible in Workday in ~~August~~ (Revised Date Pending)
...
| ------------- | ---------------- | ------- |
| Compensation Requests outside of band (cash/equity) for new hires and current team members | Chief People Officer | [Process Document](https://internal.gitlab.com/handbook/people-group/talent-acquisition/compensation-exception-process/) |
