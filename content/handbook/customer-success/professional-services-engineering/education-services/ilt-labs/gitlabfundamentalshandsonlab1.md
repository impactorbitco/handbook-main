...
- The **Assignee** is the set of people currently working on the issue. If the issue is associated with an epic, milestone, or iteration, these details will display here.
...
- **Time tracking** lets you track time taken to complete an issue. Health status lets you set a status for how the issue is progressing.
