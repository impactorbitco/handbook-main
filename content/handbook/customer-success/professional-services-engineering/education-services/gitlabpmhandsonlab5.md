...
1. In the issue's metadata pane (on the right side of the screen), click **Edit** next to the **Parent** field.
...
1. To promote this issue to an epic, use the `/promote_to epic` quick action in the issue's comment field, then click **Comment**.
