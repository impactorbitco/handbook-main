...
When Support is required during the pre-sales cycle—for example, during a POV exercise or when pursuing a potential new deal with an existing customer Solutions Architects should use the [Support Super Form](https://support-super-form-gitlab-com-support-support-op-651f22e90ce6d7.gitlab.io/) named "Allows Solution Architects to request assistance from Support Team".
