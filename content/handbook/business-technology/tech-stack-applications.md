...
**Tech Stack will be moving to HelpLab on Wednesday, October 22nd.**

- [Tech Stack on HelpLab](https://helplab.gitlab.systems/esc?id=gitlab_cmdb_applications) is located [here](https://helplab.gitlab.systems/esc?id=gitlab_cmdb_applications). You can also find it using the **"Application Tech Stack"** App in Okta.

### Have a pending Merge Request?

- No need to worry. Depending on the progress, we will complete and replicate the change onto **Tech Stack on HelpLab**.

### Plan on submitting a New Merge Request?

- Get a head start. Use the **[Tech Stack Update Form](https://helplab.gitlab.systems/esc?id=sc_cat_item&sys_id=7eee5c19ff25e6503691fe34fc4fd9ab)** in HelpLab:
- **Okta > HelpLab > IT > Tech Stack Update**

After **October 22nd**, the current `tech_stack.yml` will be archived along with the current MR process.

_– Enterprise Applications Services Team_

## Announcement - August'25

We will be transitioning the tech_stack from current YML File to HelpLab, in September. See related [epic](https://gitlab.com/groups/gitlab-com/business-technology/enterprise-apps/enterprise-applications-services/-/epics/46) for details.

**Why?**

- Asset Entitlement (who owns what and who has access to what) is critical in maintaining Operational (fiscal, compliance, security) Efficacy
- HelpLab enables us to maintain the database integrity while promoting better security hygiene

**Coming Soon**

- Here is an early preview of the **[tech_stack in HelpLab](https://helplab.gitlab.systems/esc?id=gitlab_cmdb_applications)**
- We will be publishing IT Request form to add/manage Software Entitlements in HelpLab
- We will also publish a Self-Service API Integration instructions
- Invitations to Office Hour / AMA Sessions

**Roadmap**

- Field name standardization
- Generalized field requirements
- Access Control of fields adhering to the Principle of Least privilege
