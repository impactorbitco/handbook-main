...
1. Utillize the [Lumos App Store](/handbook/security/corporate/systems/lumos/ar/) to submit a request for Zip and a separate request for Coupa]. All users requesting access to Zip also need a Coupa license to manage POs and invoices
