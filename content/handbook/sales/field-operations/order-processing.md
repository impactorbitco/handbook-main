...
GitLab provides free licenses to qualifying entities through the [Strategy Programs](/handbook/marketing/developer-relations/strategy-programs/): [GitLab for Education Program](https://about.gitlab.com/solutions/education/) and [GitLab for Open Source Program](https://about.gitlab.com/solutions/open-source/), as well as through the [GitLab for Startups Program](https://about.gitlab.com/solutions/startups/). All applications to these programs are routed through the [Strategy Programs applications automated workflows](/handbook/marketing/developer-relations/strategy-programs/program-resources/#automated-application-workflow). **Only Developer Relations team members** should handle these applications and opportunities because the team verifies program requirements before issuing/renewing licenses and these opportunities are handled differently since the opportunities are free.

#### Inquiry and Application Process (Leads or Contacts)

1. If an existing contact or new lead is interested in applying to one of the programs, use the resources in the [Strategy Programs](/handbook/marketing/developer-relations/strategy-programs/#active-programs) to guide them apropriately. If the lead has specific questions, direct them to send an email to `education@gitlab.com`, `startups@gitlab.com`, or `opensource@gitlab.com`. Then reassign the lead to the appropriate program manager (DRI).
...
1. All opportunities related to a program should be owned by the Program Manager of the corresponding program as indicated in the [Strategy Programs](/handbook/marketing/developer-relations/strategy-programs/#active-programs) handbook.
1. If you need to assign an opportunity or a renewal opportunity please reach out to the #strategy-programs Slack channel.
...
- <ins>New Business and Add-On opportunities</ins> will be Closed Won *no more than 30 days prior to the Quote Start Date* as reflected on the opportunity.
  ...
  - Ramp Deals: All future-year ramp opportunities will be Closed Won at the same time as the first-year ramp opportunity. Post-closure, any out-year ramp opportunity close dates will updated to match the start date of the ramp. See: [ARR in Practice](https://internal.gitlab.com/handbook/sales/annual-recurring-revenue-arr/)
