...
This is an informational page for an older version of the Zendesk-Salesforce sync. It is being kept around for historical purposes at this time.

If you are looking for information about the current sync, please see [Zendesk-Salesforce sync](/handbook/security/customer-support-operations/docs/zendesk-salesforce-sync/)

If you are looking for information specific to the Salesforce Case sync, please see [Salesforce cases](/handbook/security/customer-support-operations/docs/zendesk/salesforce_cases/)
