...
If you are looking for information about the current sync, please see [Zendesk-Salesforce sync workflow](/handbook/security/customer-support-operations/docs/zendesk-salesforce-sync/)
