...
When the MR is created/update, you can force deploy that exact code for the app using the pipeline run on the merge request. It contains a manually run job that will deploy it to the sandbox.
