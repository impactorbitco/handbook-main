...
aliases:
  - "/handbook/security/product-security/application-security/runbooks/unintended-vuln-disclosure/"
---
...
1. If the fix was found out to be insufficient shortly after it went out, consider opening an [AppSec review](/handbook/security/product-security/application-security/runbooks/review-process/) for that feature.
