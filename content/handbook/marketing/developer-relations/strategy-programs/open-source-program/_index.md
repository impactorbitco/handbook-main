...
* [**GitLab for Open Source Program**](/handbook/marketing/developer-relations/strategy-programs/open-source-program/#gitlab-for-open-source-program), through which qualifying open source projects receive benefits like features of GitLab Ultimate with 50,000 compute minutes for free.
* [**Consortium Memberships**](/handbook/marketing/developer-relations/strategy-programs/open-source-program/#consortium-memberships-and-sponsorships), which allow us to extend GitLab's leadership in key open source initiatives, enhance GitLab's brand, and/or improve engineering alignment
...
See the [Strategy Programs operational guidelines](/handbook/marketing/developer-relations/strategy-programs/operational-guidelines/) for more detail.
...
The GitLab for Open Source team processes applications according to the [Strategy Programs application workflow](/handbook/marketing/developer-relations/strategy-programs/program-resources/#automated-application-workflow).
For additional information on program-specific workflows, see the [Open Source Program Workflows](/handbook/marketing/developer-relations/strategy-programs/open-source-program/oss-program-workflows/) page.
...
Members of the [Strategy Programs team](/handbook/marketing/developer-relations/strategy-programs/) use GitLab Service Desk to manage program members' support requests.
