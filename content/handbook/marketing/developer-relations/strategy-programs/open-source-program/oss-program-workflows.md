...
Because the GitLab for Open Source Program is part of GitLab's [Strategy Programs](/handbook/marketing/developer-relations/strategy-programs/), team members verify applications by using the team's standard, seven-step application workflow.
See [the handbook page](/handbook/marketing/developer-relations/strategy-programs/program-resources/#automated-application-workflow) on that workflow for details that pertain to all GitLab community programs.
...
Eligibility requirements for the GitLab for Open Source Program are listed in the [program's handbook page](/handbook/marketing/developer-relations/strategy-programs/open-source-program/).
The application form performs basic alignment checks for program applications.

Verification flow for projects located on GitLab.com (SaaS) is fully automated. However, the team still needs to process the [Verification phase](/handbook/marketing/developer-relations/strategy-programs/program-resources/#verification) for Self-managed applications manually.
