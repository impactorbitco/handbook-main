...
**DRI**: [Strategy Programs](/handbook/marketing/developer-relations/strategy-programs/)

**Description**:

* Monitor potential organizations for the [Open Source program](/handbook/marketing/developer-relations/strategy-programs/open-source-program/).
...
* Monitor potential organizations for the [Startups program](/handbook/marketing/developer-relations/strategy-programs/startups-program/).
