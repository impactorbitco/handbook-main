...
| Inbound - High  | Contact Request, <br> Renewals, <br> [Hand Raise PQL](/handbook/product/product-principles/#a-pql-can-be-further-broken-down-into-two-types-usage-and-hand-raise), <br> In-app Health Check, <br> Duo Requests <br> | +100 | 1/day |
...
|MM+ Valuable Trials | MM+ and Valuable Trials (SaaS & Self-Managed) |+100 |1/6 months|
...
|* Program High| Executive Roundtables, <br> Owned Event, Live Event, <br> <br> Speaking Session,<br> Vendor Arranged Meetings,<br> Webcast <br> Live Event  |    +40    |Everytime|
...
|* Content -  Low|Content Syndication|+10| 1/30 days|
| Integrate Content Syndication - Double Tap|Integrate lead downloaded two content syndication assets (additional to regular CS score)|+10|1/30 days|
