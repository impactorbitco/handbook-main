...
| ------ | ----- |
| I am Field Marketer, and want to have people invited to my event | We typically work with the [FM process](/handbook/marketing/sales-development/#field-marketing--bdr-collaboration-process) outlined on the issue template called `FM-BDR-Collaboration-Template` that can be found [here](https://gitlab.com/gitlab-com/marketing/sales-development/-/issues/new), but are always eager to collaborate in making your events more successful, if your ask is not covered in the template linked above, please write to us on the #sales_dev_global slack channel and we'll jump in to assist. |
...
| I am an Account Executive, and want to check the state of accounts, or quality of prospects, in my territory | Our BDR team uses a set of [1:1 dashboards](/handbook/marketing/sales-development/#salesforce-and-tableau-dashboards-for-team-members) that consolidate all relevant resources in one place. Our BDR team typically uses these on 1:1s with the Sales team to facilitate better account and territory planning. |
| I am a Sales Manager, and want to gauge the quality and progress of the SAOs provided to my team. | We have a robust set of pipeline [progression dashboards](/handbook/marketing/sales-development/#salesforce-and-tableau-dashboards-for-leaders) that break down results in a lot of granularity. We also have a structured path for handing off opportunities from the SDR/BDR teams to the AE team that you can use to measure adherence to qualification criteria and next steps. |
...
| ---------------------------------------------------- | ------------------------------------------------- |
|[Marketing Operations Team](https://gitlab.enterprise.slack.com/archives/CGL35F20G)      | Reporting [bugs and issues](/handbook/marketing/marketing-operations/#how-to-get-help) around the tools that the MOPs team owns - Cognism, ZoomInfo, UserGems, Outreach, 6Sense |
| [CorpSec Team](https://gitlab.enterprise.slack.com/archives/CK4EQH50E) | Help around GitLab, Okta, your Laptop and offboarding/onboarding. HelpLab [tickets can also be used directly from here](https://helplab.gitlab.systems/esc?id=emp_taxonomy_topic&topic_id=e3812e68ebe5a210725cf4f2bad0cd53) |
| [Sales Dev Operations Team](https://gitlab.enterprise.slack.com/archives/C2V1KLY0Z) | Reaching out to our in-house team for anything day-to-day that you might need, including ideas for iterations and improvements. Please tag `@Mona`, `@Ed Bao` or `@Panos` |
| [UserGems Feedback](https://gitlab.enterprise.slack.com/archives/C07Q6GHJ2AV) | Specific to improvements on UserGems |
| [6Sense Help](https://gitlab.enterprise.slack.com/archives/C04L7EV24PK) | Specific to questions around 6Sense |
...
| [Global/Regional Sales Dev Results Dashboard](https://10az.online.tableau.com/#/site/gitlab/views/SalesDevManagerDashboard_17619453269050/TargetAttainment?:iid=1) | A Tableau dashboard that breaks down attainment in regions or teams, and current/previous Quarters. |
| [Global/Regional Sales Dev Activities Dashboard](https://10az.online.tableau.com/#/site/gitlab/views/SalesDevManagerDashboard_17619453269050/RepActivity?:iid=2) | A Tableau dashboard that breaks down the activities of team members in regions or teams, and current/previous Quarters. |
...
| :------: | :---------: |
| [GitLab LevelUp Training channel](https://levelup.edcast.com/home) | Access to GitLab LevelUp Training channel for additional learning resources. |
...
| FY26 B2 - AWA leads w/ LIM             | Includes leads in your name and that match to your Actively Working Accounts. It's best to sort these by Last Interesting Moment Date and consider the Lead Classification Score when deciding which one to add to an Outreach Sequence. We do not surface leads that were added to sequences in the last 14 days.                                                                                                                        |
...
| B2 View | Contacts related to Actively working accounts that you can choose to add to sequence                                                                                                                    |
| B3 View | Active leads in HT sequences that have a phone number - to help with call downs                                                                                                                                      |
| B4 View | Qualifying leads. Contacts that you are actively qualifying in a back and forth conversation either on email or through phone calls. Each contact in this status needs to either be active in a follow up  Outreach Sequence, have an active task or have a future meeting scheduled which can be seen in a future "last activity" date. |
...
Only named TELCO/FinServe accounts are rolling up to the TELCO/FinServe territories. If a new account is a subsidiary of an existing carved company, regardless of sub-industry, it will need to be assigned to the AE owning the ultimate account. If it is a totally separate entity then it can be allocated to the regional AE. If a lead comes in that is related to a TELCO/FinServe account, it must be assigned to the BDR assigned on the account.
...
**1. Determining High-touch or Low-touch Outreach Sequence usage:**
...
1. Research the appropriate Outreach collections for relevant collateral to be used. Most typically our High-Touch Collection or Low-Touch collections.
...
### Outreach Handbook Page

Link to the [Marketing Outreach Handbook Page](/handbook/marketing/marketing-operations/outreach/)

#### Sales Dev Sequence Creation Process

Link to Sales Dev Process can be [found here](/handbook/marketing/marketing-operations/outreach/#sales-dev-sequence-creation-process)

#### White Glove Event Follow Up sequences

For more personal events, such as Executive Roundtables, there may be more detailed Last Event Notes that include a request to involve people who interacted with the prospect at the event. For these situations, we have specialized white glove sequences. These can be found by searching for the tag `MOTION: White Glove`

The goal of these sequences is to reach out to the prospect quickly and to include our SAEs/AEs in the conversation.

- The first step is to add the prospect to the sequence. Then, customize the first email step to include the individuals mentioned in the Last Event Notes. You can also delay the first email to allow time for feedback from the SAE/AE if needed.
...
| Worked in FY Reason       | Automatically populates when an account gets moved to Worked in FY prospecting status. If an account needs to be added to this status before its appropriate date, this field needs to be manually populated with one of the choices provided. |
...
| Days in Actively Working Status | Stamps the count of days that an account was in Actively Working status between a move from `Actively Working` to `Worked in FY` statuses for any scenario. |
...
Determine the number of prospects you plan to add to sequence, with a minimum of 25 per day. Utilize LinkedIn Sales Navigator, ZoomInfo or Cognism to identify these personas within your target companies.
...
1. **Rebooking no-shows**: The SDR's responsibility lies only in rebooking no-shows using a structured Outreach Sequence.
...
1. Add all leads to sequences, if you're reaching out to them.
...
| Impartner Partner Account | If populated, the lead/contact is worked by a partner, and Sales Dev should not proceed with outreach.                                                                     |
...
Please find some [guidance here](https://docs.google.com/presentation/d/1ZwemeDll2Zz4nwhtIFD64edcQCJ6nFYHv6fOPPqV2Hs/edit?slide=id.g3a48b9b62d8_0_18#slide=id.g3a48b9b62d8_0_18) along with a [video walkthrough](https://drive.google.com/file/d/1Gn6BjD6TfRNJ1eDGf3rAUJfA4g7LmCnd/view?usp=sharing)
...
- [Sales Development Personalisation Claude Project](https://claude.ai/project/019a15a5-c78c-71dc-8ce8-f68048ec8e63)
...
1. I cannot update leads/contact through LISN. Can this functionality be turned on?
   1. The Marketing Operations and Sales Operations teams have evaluated this functionality and have determined that allowing lead/contact updates through LISN could negatively effect downstream data sequences since LISN is not considered a SSoT data provider.
...
- We expect that our [standard RoE](/handbook/marketing/sales-development/#frequently-asked-questions-faq-and-rules-of-engagement-roe) will be followed normally in actioning these leads, similar to MQLs.
- These leads will be routed to the BDR team if there's a BDR assigned and any of the following criteria below:
  - MM and First Order
  - Is Focus Account Person
  - Actively Working
  - PubSec, FINS, Telco, BASE or APJ
...
- We expect that our [standard RoE](/handbook/marketing/sales-development/#frequently-asked-questions-faq-and-rules-of-engagement-roe) will be followed normally.`
...
- These people are not enrolled to a specific sequence, since there multiple scenarios on how to best address them, please search Outreach for templated messages.

#### Gem-E FY26 Auto Enrollment

For FY26Q1 we will pilot auto-enrolling UG leads to a dedicated Outreach Sequence which will make sure of UserGem's AI functionalities.

- Leads that have no activity, and match the filters on the [SMB report here](https://gitlab.lightning.force.com/lightning/r/Report/00OPL00000E1hpG2AR/view) or [MM/ENTG report here](https://gitlab.lightning.force.com/lightning/r/Report/00OPL00000E1bYY2AZ/view) will be automatically added to a User Gems Sequence
- These sequences will automatically include AI generated customisation. Please review the [slides](https://docs.google.com/presentation/d/1LlIjaRjwVaTI5XbWkU2fIEhhq7rYthuPGh-aaNqJz2o/edit#slide=id.g2d902c263b1_0_581) or the [video presentation here](https://www.loom.com/share/b3bc2eb774064800b8170c245434d17b) for a full walkthrough.
...
- [Call Coaching Guidelines](/handbook/marketing/marketing-operations/outreach/#call-coaching-best-practices)
...
| 1:1 Account Dashboard | 16. Review individuals in flight. | **For accounts not in AWA:** <br> This report shows a breakdown of prospects currently on a Outreach Sequence. Should be reviewed for any further actions to be taken. | Consider whether adding more individuals to a sequence for a particular account might make sense, or whether the individuals from the top prospect accounts should be getting additional outreach outside of the sequence steps. |
...
- **Type**
  ...
  - Operations -  (Process Change, Tools, sequence, Reports, System Changes/System Updates )
...
The below are a selection of reports and initiatives that can be used for your prospecting efforts.
...
These reports connect to the [initiative outlined here](https://gitlab.com/gitlab-com/marketing/sales-development/-/issues/1411), which focused on accounts that are more likely to have shorter sales cycles and thus convert to SAO quicker.

**[6Sense Short Sales Cycle Accounts](https://gitlab.abm.6sense.com/segments/segment/2226154/accounts)** <br>
**[SFDC Short Sales Cycles Accounts](https://gitlab.my.salesforce.com/00OPL00000J9kru)** <br>

#### Churn and Expand Opportunity Reports

These reports connect to the initiative outlined [here](https://gitlab.com/gitlab-com/marketing/sales-development/-/work_items/1583) and aim to identify either accounts that have the danger to churn in their next renewal, or accounts with propensity to expand on their next renewal.

When using these templates:

- Please clone the templates, and change the `Account Demographics: Territory` field to the territory you work with.
- Use the account health metrics and Propensity To Churn metrics to sort through results. You can find some [further guidance on these data-points here.](https://docs.google.com/presentation/d/184RA89u_vYuSy6xuH9kkiWZUNIjH6BWSOVWfODq_LOc/edit?slide=id.g2f4dd7e9716_0_0#slide=id.g2f4dd7e9716_0_0)
- Use the `BDR Account Strategy` field values for `Growth - Upgrade` or `Risk Of Churn` to denote what accounts you're targetting.  

**[Expand Prospect Accounts](https://gitlab.my.salesforce.com/00OQq000003heJp)** <br>
...
### SDR Inbound Rules of Engagement (ROE)

**1. SMB (0 to 250)**

- **Customers**
  - Do Not Work If:
    - A lead/contact is route to you, pass to SMB Team
    - If there is a need for a renewal, convert to a contact and create a renewal case
- **Prospects**
  - SDR is free to work SMB Prospects

**2. MidMarket (250 to 2.4K)**

- **Customers**
  - Do Not Work If:
    - A lead/contact is routed to you, pass to:
      - BDR assigned if Actively Working
      - AE Account Owner if not Actively Working
      - Base BDR if Base territory (AWA or Not)
      - If the account type is partner pass it to the Account Owner

- **Prospects**
  - Can Work If:
    - Not an Actively Working Account
    - No open Opps
    - Is not a part of a Base Territory

**2. Large/Enterprise (2.5K+)**

- **Customers**
  - Do Not Work If:
    - If Actively Working
    - If part of a Base Territory  
    - If in an Open Opportunity
      - Pass lead/contact to BDR Assigned if AWA
  - If you work a customer align with the AE before reaching out
...
### Standard BDR Rules Of Engagement (RoE)
...
6. Does the account have activity placed by the BDR in the last 30 days?
    ...
    **Next Steps:** SDR chatters the BDR Assigned and lets them know you didn't find activity and will go ahead and sequencethe lead. FYI's the BDR Manager. BDR Manager will work with the BDR to put the account into the correct BDR Prospecting status. If a BDR is able to relay information that was not picked up in the SDR's research, the SDR should end the sequence if the prospect hasn't engaged and change lead ownership to BDR so the BDR can reach out. If the SDR has engaged with the prospect, there will need to be a coordinated handoff worked out between SDR and BDR. Note: Only activity logged in SFDC will be recognized as activity.
...
**A:** Partner leads will not be asigned to BDRs or SDRs as they will be assigned to the Partner Queue. To tell whether a lead is associated to a Partner Account, check their `Impartner Partner Account` - if it's empty, you are may proceed with outreach.

**Q:** When a partner lead is assigned to Partner, when and how can we recall the lead?
**A:** Partner lead will be recalled after a certain period of time if they are not accepted by Partners for joint marketing campaigns. They will be initially be recalled with a Recycle status, once they become MQL, they will be assigned to BDRs or SDRs. For more information on this process, see the [Impartner Handbook Page](/handbook/marketing/marketing-operations/impartner/#partner-recall).
...
| | - BDR is now able to create their own Outreach Sequences pending approval.               |
...
|                                    | - Work lead records within Salesforce by leveraging relevant sequence tags in Outreach.                                                                                            |
...
| Low vs High Touch Outreach Sequence Usage    | - Over 70% of inbound leads enrolled to High Touch Sequences.        |
...
In accordance with the [Time Off Policy](/handbook/people-group/time-off-and-absence/time-off-types/), you need give your manager a heads up early of your intended time off so that they can help arrange cover for your tasks, if necessary.
