...
- Ideal customer speaker profile parameters include:
  ...
  - Speaker title / level
  - Speaker expertise
- FMM creates the Asana event project and completes the `Request staffing and internal support` task, following the instructions for determining a customer speaker (which involves adding a CA tag to the task and tagging Nicole Smith)
