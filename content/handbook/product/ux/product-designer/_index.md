...
- **Discover unknown pain points**:
  ...
  - Use [Gong](https://www.gong.io/) to search and listen to sales call recordings and transcriptions for insights.
...
To **design AI solutions** thoughtfully, follow the [AI design guide](/handbook/product/ux/product-designer/ai-design.md).
It helps you ensure that the technology enhances the user experience and meets strategic objectives.

For how you should **use AI in your design work**, see [AI usage in UX](/handbook/product/ux/how-we-work/ai-usage/).
Learn when to use AI, best practices, what to avoid, and how to keep users at the center while using AI as a helper.
