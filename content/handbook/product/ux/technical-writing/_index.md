...
|:--------------------------|:--------------------|
| AI                        | {{< member-by-name "Sarah Watt" >}} |
| Analytics & Monetization (incl. Growth and Fulfillment)  | {{< member-by-name "Diana Logan" >}} |
| Core DevOps               | {{< member-by-name "Michael Belton" >}} |
| Security & Platforms (incl. Dedicated)      | {{< member-by-name "Robert Landry" >}} |
...
- Assisting [Docs Engineers](/job-families/product/ux-fullstack-engineer/) with operations tasks when asked, or when
...
| [Documentation testing](#documentation-testing) (DocOps/Vale/markdownlint)           | {{< member-by-name "Michael Belton" >}} |
...
- **Release post structural check:** The Technical Writing Lead [reviews the content](/handbook/marketing/blog/release-posts/#tw-lead) for the release post published at the end of each milestone. For assignments, see the [Release Post Scheduling](/handbook/marketing/blog/release-posts/managers/) page.
...
|---------|-------|------------------------------|---------------------|-------------------|
| 19.1| June 2026 | TBD | TBD | {{< member-by-name "Uma Chandran" >}} |
| 19.0| May 2026 | TBD | {{< member-by-name "Kati Paizee" >}} | {{< member-by-name "Marcin Sędłak-Jakubowski" >}} |
| 18.11| April 2026 | {{< member-by-name "Uma Chandran" >}} | {{< member-by-name "Marcin Sędłak-Jakubowski" >}} | {{< member-by-name "Ryan Lehmann" >}} |
| 18.10| March 2026 | {{< member-by-name "Marcin Sędłak-Jakubowski" >}} | {{< member-by-name "Ryan Lehmann" >}} | {{< member-by-name "Brendan Lynch" >}} |
| 18.9 | February 2026 | {{< member-by-name "Ryan Lehmann" >}} | {{< member-by-name "Brendan Lynch" >}} | {{< member-by-name "Evan Read" >}} |
