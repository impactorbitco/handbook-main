...
Forums are scheduled every two weeks. They are 60 minutes long to allow up to three team members to share for 15 minutes, plus 5 minutes of discussion time with the attendees. A fourth speaker spot is available to allow for flexibility in scheduling, but ideally most UX forums should only have three speakers.
...
- Announce in the `#ux` channel that you'd like to trade.
- After you identify a trade, make an MR to update the schedule.
- Ask your Product Design Manager to review and merge.

**Live presentation is required**. Please do not record your topic in advance. The value of UX Forums comes from real-time discussion, the ability for attendees to ask questions and engage directly with you about your work, and the opportunity to share your work live with team members. Since we work remotely, these forums are one of the few occasions for this kind of direct interaction.
...
Product Design Managers take turns hosting the UX Forum. Managers can use the [UX Forum issue template](https://gitlab.com/gitlab-org/gitlab-design/-/issues/new?issuable_template=UX%20Forum) to create tracking issues for each session. See [how to use templates](https://docs.gitlab.com/user/project/description_templates/#use-the-templates). The current host creates the issue for the next host.
...
- Remove the session that just completed
- Create the [issue](https://gitlab.com/gitlab-org/gitlab-design/-/issues/new?issuable_template=UX%20Forum) for the next scheduled session.
