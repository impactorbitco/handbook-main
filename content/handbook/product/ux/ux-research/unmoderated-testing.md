...
- **How do I get an account?** Request via [Lumos](https://app.lumosidentity.com/app_store), which is accessible via Okta. UserTesting.com seats are allocated only to Product Designers and UX Researchers at this time, since those are the disciplines that are closely involved with solution validation and Category Maturity Scorecard testing.
